      ...
      <div class="flex flex-wrap -m-4">
        <div class="w-full lg:w-1/3 p-4">
          <div class="bg-white shadow rounded overflow-hidden">
            ...
            <div class="px-6 mb-6">
              <h4 class="text-xl font-bold">Alimentar um banco de dados</h4>
              <p class="text-xs text-gray-500">
                Example of the team working on a project
              </p>
            </div>
            <div class="p-6 bg-lightGray-50">
              <div class="flex -mx-2 mb-6">
                <div class="w-1/2 px-2">
                  ...
                  <span
                    ...
                    "
                    >14 de Março 2021</span
                  >
                </div>
                <div class="w-1/2 px-2">
                  <p class="mb-2 text-xs font-medium">Valor</p>
                  <span
                    class="
                      inline-block
                      py-1
              ...
              <p class="mb-2 text-xs font-medium">Host++</p>
          ...
          <div class="bg-white shadow rounded overflow-hidden">
            <div class="pt-6 px-6 mb-10 flex justify-between items-center">
              ...
              >
                <img
                  class="h-6"
                  src="artemis-assets/mini-logos/spotify.svg"
                  alt=""
                />
              </span>
              <a
            ...
            <div class="px-6 mb-6">
              <h4 class="text-xl font-bold">Criar um esboço de tela</h4>
              <p class="text-xs text-gray-500">
                Example of the team working on a project
              </p>
            </div>
          ...
          <div class="bg-white shadow rounded overflow-hidden">
            ...
            <div class="px-6 mb-6">
              <h4 class="text-xl font-bold">
                Desenvolver um footer responsivo
              </h4>
              <p class="text-xs text-gray-500">
                Example of the team working on a project
              </p>
        ...
        <div class="w-full lg:w-1/3 p-4">
          <div class="bg-white shadow rounded overflow-hidden">
            ...
            <div class="px-6 mb-6">
              <h4 class="text-xl font-bold">Criar um cabeçalho com logo</h4>
              <p class="text-xs text-gray-500">
                Example of the team working on a project
              </p>
            </div>
            <div class="p-6 bg-lightGray-50">
              <div class="flex -mx-2 mb-6">
                <div class="w-1/2 px-2">
                  <p class="mb-2 text-xs font-medium">Postagmem</p>
                  <span
                    class="
                      inline-block
                      py-1
        ...
        <div class="w-full lg:w-1/3 p-4">
          <div class="bg-white shadow rounded overflow-hidden">
            ...
            <div class="px-6 mb-6">
              <h4 class="text-xl font-bold">Calculadora simples de IMC</h4>
              <p class="text-xs text-gray-500">
                Example of the team working on a project
              </p>
            </div>
        ...
        <div class="w-full lg:w-1/3 p-4">
          <div class="bg-white shadow rounded overflow-hidden">
            ...
            <div class="px-6 mb-6">
              <h4 class="text-xl font-bold">
                Elaborar a estrutura de um banco de dados
              </h4>
              <p class="text-xs text-gray-500">
                Example of the team working on a project
              </p>
