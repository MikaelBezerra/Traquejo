<template>
  <div>
    <!-- Perfil -->
    <div class="card py-6 w-full relative flex flex-col shadow-xl">
      <div
        class="
          block
          h-36
        ...
        style="z-index: -1"
      />
      <div class="profile w-full flex m-7 ml-16 text-white">
        <img
          ...
          alt=""
        />
        <div class="title text-2xl mt-12 ml-5 font-bold flex flex-col">
          <div class="name">Thomas Brown</div>
          <div class="add font-semibold text-black text-xl py-2 italic dark">
            Back-end
          </div>
        </div>
      </div>
    ...
    <!-- ----------------------------------------- -->
    <!-- sobre -->
    <div class="py-4 flex w-full items-center inline-block">
      <!-- Dinheiro -->
      <div class="w-1/2">
        <div
          class="
        ...
        >
          ...
          <div class="w-4/6">
            ...
            <p class="text-gray-600 text-base">
              Lorem ipsum, dolor sit amet consectetur adipisicing elit. Quod perspiciatis consectetur volup
            </p>
            <p class="text-white text-2xl font-semibold py-1">R$719,98</p>
          </div>
        </div>
      </div>

      <!-- Avaliação -->
      <div class="w-1/2 flex-1 items-center">
        <ul>
          <!--Atendimento-->
          <li class="py-2">
    ...
    <div>
      <div>
        <h1 class="text-2xl font-bold py-4 px-5 items-center shadow-md justify-center">Propostas</h1>
      </div>
      <div class="py-5 flex inline-block w-full">
        <!--Card-->
        <div class="max-w-sm mx-auto overflow-hidden bg-gray-800 rounded-lg shadow-lg">
            
            <div class="flex items-center px-6 py-3 bg-purple-600">

                <h1 class="mx-3 text-lg font-semibold text-white">AG</h1>
            </div>

            <div class="px-6 py-4">
                <h1 class="text-xl font-semibold text-white">Front-end</h1>

                <p class="py-2 text-gray-300">desenvolver prototipagem.</p>
                ...
                <div class="flex items-center mt-4 text-gray-200">
                    ...
                    <h1 class="px-2 text-sm">Maringá</h1>
                </div>
                ...
                <div class="flex items-center mt-4 text-gray-200">
                    ...
                    <h1 class="px-2 text-sm">Remoto</h1>
                </div>
         ...
         <div class="max-w-sm mx-auto overflow-hidden bg-gray-800 rounded-lg shadow-lg">
            ...
            <div class="flex items-center px-6 py-3 bg-purple-600">
                ...
                <h1 class="mx-3 text-lg font-semibold text-white">lisboa</h1>
            </div>

            <div class="px-6 py-4">
                <h1 class="text-xl font-semibold text-white">back-end</h1>

                <p class="py-2 text-gray-300">lorem.</p>
                ...
                <div class="flex items-center mt-4 text-gray-200">
                    ...
                    <h1 class="px-2 text-sm">Sarandi</h1>
                </div>
                ...
                <div class="flex items-center mt-4 text-gray-200">
                    ...
                    <h1 class="px-2 text-sm">presencial</h1>
                </div>
                ...
                <div class="flex items-center mt-4 text-gray-200">
                    ...
                    <h1 class="px-2 text-sm">lisboa-email@example.com</h1>
                </div>
                <div class="py-2 px-4 w-full flex items-center justify-center">
         ...
         <div class="max-w-sm mx-auto overflow-hidden bg-gray-800 rounded-lg shadow-lg">
            ...
            <div class="flex items-center px-6 py-3 bg-purple-600">
                ...
                <h1 class="mx-3 text-lg font-semibold text-white">TecnoLisboa</h1>
            </div>

            <div class="px-6 py-4">
                <h1 class="text-xl font-semibold text-white">dev</h1>

                <p class="py-2 text-gray-300">Delphi.</p>
                ...
                <div class="flex items-center mt-4 text-gray-200">
                    ...
                    <h1 class="px-2 text-sm">Rio de Janeiro</h1>
                </div>
                ...
                <div class="flex items-center mt-4 text-gray-200">
                    ...
                    <h1 class="px-2 text-sm">tecnoLisboa-email@example.com</h1>
                </div>
                <div class="py-2 px-4 w-full flex items-center justify-center">
                  <button class="bg-purple-600 items-center justify-center text-center py-3 px-4 text-white font-bold text-sm rounded-lg">Participar</button>
                </div>
         ...
         <div class="max-w-sm mx-auto overflow-hidden bg-gray-800 rounded-lg shadow-lg">
            ...
            <div class="flex items-center px-6 py-3 bg-purple-600">
                ...
                <h1 class="mx-3 text-lg font-semibold text-white">Par-B</h1>
            </div>

            <div class="px-6 py-4">
                <h1 class="text-xl font-semibold text-white">Design</h1>

                <p class="py-2 text-gray-300">Redes Sociais</p>
                ...
                <div class="flex items-center mt-4 text-gray-200">
                    ...
                    <h1 class="px-2 text-sm">Par-email@example.com</h1>
                </div>
                <div class="py-2 px-4 w-full flex items-center justify-center">
                  <button class="bg-purple-600 items-center justify-center text-center py-3 px-4 text-white font-bold text-sm rounded-lg">Participar</button>
                </div>
