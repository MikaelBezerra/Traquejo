<template>
  <div class="py-12 md:py-32 overflow-x-hidden">
    <div class="container px-4 mx-auto">
      <div class="flex flex-wrap lg:flex-nowrap">
        ...
        <div class="relative w-full lg:w-1/2 my-12 lg:my-0">
          <img
            class="relative mx-auto rounded-xl w-full z-10"
            src="https://static.shuffle.dev/uploads/files/ac/ac7d4a2e7aef225f35fbfa89c381e462efff1e77/76.jpg"
            alt=""
          />
          <img
            class="absolute top-0 left-0 w-40 -ml-12 -mt-12"
            src="metis-assets/elements/blob-tear.svg"
            alt=""
          />
          <img
            class="absolute bottom-0 right-0 w-40 -mr-12 -mb-12"
            src="metis-assets/elements/blob-tear.svg"
            alt=""
          />
        </div>
